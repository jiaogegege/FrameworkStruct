...
class AnimationDemoViewController: BasicViewController {
    ...
    override func configUI() {
        ...
        _ = AnimationManager.shared.popBasic(propertyName: kPOPViewCenter, toValue: CGPoint(x: 300, y: 300), duration: 1, isLoop: true, repeatCount: 2, autoReverse: true, host: v) {
            FSLog("POP动画完成")
        }
